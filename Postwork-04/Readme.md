...
Cociente. Agregamos la columna del producto de las probabilidades marginales

```R
probdf$prodMarginal <- probdf$marginalcasa*probdf$marginalvisita
```
Agregamos la columna del cociente de la probabilidad conjunta entre el producto de las marginales
